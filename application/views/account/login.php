...
<head>
  ...
  <title>Sign up - Towo account</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Admin</b>Jakarta Dental Project</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url('index.php/login/proses');?>" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="go">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    <!-- <div class="social-auth-links text-center">
      <p>- OR -</p>
      <a href="<?php echo $login_url;?>" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign in using
        Facebook</a> -->
      <!-- <a href="<?php //echo base_url('login/with_goo')?>" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Sign in using
        Google+</a>-->
   <!--  </div>  -->
    <!-- /.social-auth-links -->

   <!--  <a href="<?php echo base_url('login/reset')?>">I forgot my password</a><br>
