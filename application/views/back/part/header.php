        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url()."/back/dist/img/avatar.png";?>" class="user-image" alt="User Image">
              <!-- 1 -->
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <img src="<?php echo base_url()."/back/dist/img/avatar.png";?>" class="img-circle photo" alt="User Image" width='30%' height='30%'>
