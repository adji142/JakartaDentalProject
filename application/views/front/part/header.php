...
<html lang="zxx">
<head>
    <title>Jakarta Dental Project</title>
    ...
    <!-- Custom Theme files -->
    <link href="<?php echo base_url();?>front/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
    <link href="<?php echo base_url();?>front/css/style.css" type="text/css" rel="stylesheet" media="all">
    <!-- font-awesome icons -->
    <link href="<?php echo base_url();?>front/css/fontawesome-all.min.css" rel="stylesheet">
    <!-- //Custom Theme files -->
