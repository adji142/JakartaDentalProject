<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	*/
	class dashboard extends CI_Controller
	{
		...
		function slider(){
			$data['title']="Ganti Slider di Header halaman Depan";
			$this->load->view('back/slider',$data);
		}
		function staff()
		{
			$data['title']="Staff Jakarta Dental Project";
			$this->load->view('back/staff',$data);
		}
		function about()
		{
			$data['title'] = "About Dental Project";
			$this->load->view('back/about',$data);
		}
		function galeri()
		{
			$data['title'] = "Galery Dental Project";
			$this->load->view('back/galeri',$data);
		}
		function profile(){
